...
\input{chapters/quadraticH.tex}
\input{chapters/ptrsptbe.tex}
\input{chapters/topoHiggs.tex}
\input{chapters/conclusion.tex}

\backmatter
\bibliography{bib/thesis}  % 参考文献使用 BibTeX 编译
% \printbibliography       % 参考文献使用 BibLaTeX 编译

\appendix
\input{chapters/complementaryBBdG.tex}
\input{chapters/complementaryptrs.tex}
